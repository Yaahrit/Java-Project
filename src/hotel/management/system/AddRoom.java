...
public class AddRoom extends JFrame implements ActionListener {
        ...
        public AddRoom() {
                ...
                comboBox = new JComboBox<>(new String[] { "Available", "Occupied","Not available" });
                ...
                comboBox_3 = new JComboBox<>(new String[] { "Single Bed", "Double Bed","Single bed with Ac","Double bed with Ac and T.V" });
